...
import com.lemon.app.util.DateUtil;
import com.lemon.app.util.ScreenUtil;
...
public class TestListener extends TestListenerAdapter {
	...
	public void onTestFailure(ITestResult tr){
		...
		String destination=surefireDir+File.separator+"screenshot"+File.separator+"app"+File.separator+testName+File.separator+currentTimeStr;
